...
urlpatterns = [
    ...
    path("<uuid:pk>/adjust-placements/", views.document_adjust_placements, name="document_adjust_placements"),
    path("<uuid:pk>/save-placements/", views.save_placements, name="save_placements"),
